...
})({"PPEoV":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "4a236f9275d0a351";
module.bundle.HMR_BUNDLE_ID = "93e4edee9eba109e";
"use strict";
...
},{}],"gr9xA":[function(require,module,exports) {
...
_vue.createApp(_appVueDefault.default).use(_routerDefault.default)//    .use(store)
//    .use(cookie)
.mount('#app');

},{"vue":"a2RR7","../vue/App.vue":"1AfIi","./router":"kwPk6","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"a2RR7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
        ...
        resolve (resume = false) {
            ...
            if (suspense.isHydrating) suspense.isHydrating = false;
                ...
                if (delayEnter) activeBranch.transition.afterLeave = ()=>{
                    if (pendingId === suspense.pendingId) move(pendingBranch, container, anchor1, 0 /* ENTER */ );
                };
                ...
                move(pendingBranch, container, anchor1, 0 /* ENTER */ );
            }
    ...
    const hooks = {
        ...
        leave (el, remove) {
            ...
            const done = el._leaveCb = (cancelled)=>{
                ...
                el._leaveCb = undefined;
                if (leavingVNodesCache[key] === vnode1) delete leavingVNodesCache[key];
            };
            leavingVNodesCache[key] = vnode1;
            if (onLeave) {
                onLeave(el, done);
...
function trigger(target, type, key, newValue, oldValue, oldTarget) {
    ...
    else if (key === 'length' && _shared.isArray(target)) depsMap.forEach((dep, key)=>{
...
class CustomRefImpl {
    constructor(factory){
        this.dep = undefined;
        this.__v_isRef = true;
        const { get , set  } = factory(()=>trackRefValue(this)
...
},{}],"1AfIi":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    ...
    script.__scopeId = 'data-v-87540c';
    script.__file = "C:\\Users\\Lukáš Odler\\code\\personal\\business-card\\assets\\vue\\App.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = '87540c-hmr';
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord('87540c-hmr', script)) __VUE_HMR_RUNTIME__.reload('87540c-hmr', script);
        }, 0);
    });
}
exports.default = script;

},{"script:./App.vue":"feQVh","template:./App.vue":"40pdj","style:./App.vue":"lOh9v","custom:./App.vue":"judVB","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"feQVh":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = {
    components: {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"40pdj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render
);
var _vue = require("vue");
const _withScopeId = (n)=>(_vue.pushScopeId("data-v-87540c"), n = n(), _vue.popScopeId(), n)
;
const _hoisted_1 = {
    id: "bg"
};
...
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender('87540c-hmr', render);
});

},{"vue":"a2RR7","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"lOh9v":[function() {},{}],"judVB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"kwPk6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _vueRouter = require("vue-router");
var _notFoundVue = require("../vue/routes/NotFound.vue");
var _notFoundVueDefault = parcelHelpers.interopDefault(_notFoundVue);
var _businessCardVue = require("../vue/routes/BusinessCard.vue");
var _businessCardVueDefault = parcelHelpers.interopDefault(_businessCardVue);
const routes = [
    {
        path: '/',
        name: 'businessCard',
        component: _businessCardVueDefault.default
    },
    {
        path: '/error',
        name: 'error',
...
},{"vue-router":"2W6wr","../vue/routes/NotFound.vue":"5kl9J","../vue/routes/BusinessCard.vue":"4sXE5","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"2W6wr":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"5kl9J":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require('script:./NotFound.vue');
    if (script.__esModule) script = script.default;
    script.render = require('template:./NotFound.vue').render;
    require('custom:./NotFound.vue').default(script);
    script.__scopeId = 'data-v-7bf381';
    script.__file = "C:\\Users\\Lukáš Odler\\code\\personal\\business-card\\assets\\vue\\routes\\NotFound.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = '7bf381-hmr';
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord('7bf381-hmr', script)) __VUE_HMR_RUNTIME__.reload('7bf381-hmr', script);
        }, 0);
    });
}
exports.default = script;

},{"script:./NotFound.vue":"80s5A","template:./NotFound.vue":"hgozY","custom:./NotFound.vue":"cjfgg","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"80s5A":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = {
    components: {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"hgozY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render
);
...
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender('7bf381-hmr', render);
});

},{"vue":"a2RR7","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"cjfgg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"4sXE5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let script;
let initialize = ()=>{
    script = require('script:./BusinessCard.vue');
    if (script.__esModule) script = script.default;
    script.render = require('template:./BusinessCard.vue').render;
    script.__cssModules = require('style:./BusinessCard.vue').default;
    require('custom:./BusinessCard.vue').default(script);
    script.__scopeId = 'data-v-3b2b5d';
    script.__file = "C:\\Users\\Lukáš Odler\\code\\personal\\business-card\\assets\\vue\\routes\\BusinessCard.vue";
};
initialize();
if (module.hot) {
    script.__hmrId = '3b2b5d-hmr';
    module.hot.accept(()=>{
        setTimeout(()=>{
            initialize();
            if (!__VUE_HMR_RUNTIME__.createRecord('3b2b5d-hmr', script)) __VUE_HMR_RUNTIME__.reload('3b2b5d-hmr', script);
        }, 0);
    });
}
exports.default = script;

},{"script:./BusinessCard.vue":"1gMg6","template:./BusinessCard.vue":"5lwgv","style:./BusinessCard.vue":"jXY2g","custom:./BusinessCard.vue":"7W9A7","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"1gMg6":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = {
    components: {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"5lwgv":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "render", ()=>render
);
var _vue = require("vue");
const _withScopeId = (n)=>(_vue.pushScopeId("data-v-3b2b5d"), n = n(), _vue.popScopeId(), n)
;
const _hoisted_1 = {
    class: "w-full h-screen p-10 flex justify-center items-center"
};
const _hoisted_2 = /*#__PURE__*/ _withScopeId(()=>/*#__PURE__*/ _vue.createElementVNode("div", {
        id: "card",
        class: "w-full h-1/2"
    }, [
        /*#__PURE__*/ _vue.createElementVNode("div", {
            id: "inner",
            class: "w-full h-full relative"
        }, [
            /*#__PURE__*/ _vue.createElementVNode("div", {
                id: "front",
                class: "absolute top-0 left-0 w-full h-full bg-white rounded-lg"
            }),
            /*#__PURE__*/ _vue.createElementVNode("div", {
                id: "back",
                class: "absolute top-0 left-0 w-full h-full bg-red-600 rounded-lg"
            })
        ])
    ], -1 /* HOISTED */ )
);
...
function render(_ctx, _cache) {
    return _vue.openBlock(), _vue.createElementBlock("div", _hoisted_1, _hoisted_3);
}
if (module.hot) module.hot.accept(()=>{
    __VUE_HMR_RUNTIME__.rerender('3b2b5d-hmr', render);
});

},{"vue":"a2RR7","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"jXY2g":[function() {},{}],"7W9A7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
let NOOP = ()=>{
};
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["PPEoV","gr9xA"], "gr9xA", "parcelRequirebcf7")

//# sourceMappingURL=index.9eba109e.js.map
